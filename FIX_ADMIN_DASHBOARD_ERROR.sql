-- ============================================
-- FIX ADMIN DASHBOARD GROUP BY ERROR
-- ============================================
-- This fixes the "column u.created_at must appear in GROUP BY" error
-- Copy and paste this entire file into Supabase SQL Editor and run it
-- ============================================

-- Fix get_admin_stats() function to avoid GROUP BY error
...
BEGIN
  ...
  -- This approach prevents the GROUP BY error by querying users first, then aggregating
  SELECT COALESCE(
    json_agg(
      json_build_object(
        'id', u.id,
  ...
  -- Build stats object with all the counts
...
-- ============================================
-- VERIFICATION (optional - you can run this to test)
-- ============================================
